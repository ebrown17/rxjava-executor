...
public class RxJavaExecutor {
  ...
  /**
   * Schedules a callable to be run using an RxJava
   * {@link io.reactivex.Flowable#timer(long, TimeUnit, Scheduler)}
   * <p>
   * This is run on this RxJavaExecutor's
   * {@link io.reactivex.internal.schedulers.ComputationScheduler}
   * </p>
   * <p>
   * Scheduling a callable with this is limiting as you can't react to the state of the callable
   * return. Recommended to use a {@link io.reactivex.Flowable}
   * and one of this RxJavaExecutor's schedulers directly.
   * </p>
   *
  ...
  /**
   * Schedules a runnable to be run using an RxJava
   * {@link io.reactivex.Flowable#timer(long, TimeUnit, Scheduler)}
   * <p>
   * This is run on this RxJavaExecutor's
   * {@link io.reactivex.internal.schedulers.ComputationScheduler}
  ...
  /**
   * Schedules a runnable to be run at a fix rate using an RxJava
   * {@link io.reactivex.Flowable#interval(long, long, TimeUnit, Scheduler)}
   * <p>
   * This is run on this RxJavaExecutor's
   * {@link io.reactivex.internal.schedulers.ComputationScheduler}
   * </p>
  ...
  /**
   * Schedules a callable to be run at a fixed rate using an RxJava
   * {@link io.reactivex.Flowable#interval(long, long, TimeUnit, Scheduler)}
   * <p>
   * This is run on this RxJavaExecutor's
   * {@link io.reactivex.internal.schedulers.ComputationScheduler}
   * </p>
   * <p>
   * Scheduling a callable with this is limiting as you can't react to the state of each callable
   * return. Recommended to use a {@link io.reactivex.Flowable}
   * and one of this RxJavaExecutor's schedulers directly.
   * </p>
   *
